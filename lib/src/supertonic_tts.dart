...
const Map<int, List<int>> _latinDecompositions = {
  ...
  0x00D3: [0x004F, 0x0301], 0x00DA: [0x0055, 0x0301], 0x00E1: [0x0061, 0x0301],
  0x00E9: [0x0065, 0x0301], 0x00ED: [0x0069, 0x0301], 0x00F3: [0x006F, 0x0301],
  0x00FA: [0x0075, 0x0301], 0x00C0: [0x0041, 0x0300], 0x00C8: [0x0045, 0x0300],
  0x00CC: [0x0049, 0x0300], 0x00D2: [0x004F, 0x0300], 0x00D9: [0x0055, 0x0300],
  0x00E0: [0x0061, 0x0300], 0x00E8: [0x0065, 0x0300], 0x00EC: [0x0069, 0x0300],
  0x00F2: [0x006F, 0x0300], 0x00F9: [0x0075, 0x0300], 0x00C2: [0x0041, 0x0302],
  0x00CA: [0x0045, 0x0302], 0x00CE: [0x0049, 0x0302], 0x00D4: [0x004F, 0x0302],
  0x00DB: [0x0055, 0x0302], 0x00E2: [0x0061, 0x0302], 0x00EA: [0x0065, 0x0302],
  0x00EE: [0x0069, 0x0302], 0x00F4: [0x006F, 0x0302], 0x00FB: [0x0075, 0x0302],
  ...
  0x00D6: [0x004F, 0x0308], 0x00DC: [0x0055, 0x0308], 0x00E4: [0x0061, 0x0308],
  0x00EB: [0x0065, 0x0308], 0x00EF: [0x0069, 0x0308], 0x00F6: [0x006F, 0x0308],
  0x00FC: [0x0075, 0x0308], 0x00C7: [0x0043, 0x0327], 0x00E7: [0x0063, 0x0327],
};
...
class SupertonicTTS {
  ...
  Future<void> initialize({
    ...
    _textProcessor = await _UnicodeProcessor.load('$onnxDir/unicode_indexer.json');
  ...
  Future<TTSResult> synthesize(
    ...
    if (!_isInitialized) {
      throw StateError('SupertonicTTS not initialized. Call initialize() first.');
    }
  ...
  Future<Map<String, dynamic>> _infer(
    ...
    final vocoderResult =
        await _vocoderOrt!.run({'latent': await _toTensor(noisyLatent, latentShape)});
